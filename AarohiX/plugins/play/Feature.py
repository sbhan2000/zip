...
@app.on_message(
    filters.command(["مميزات","مميزات سي جي"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس 𝗖𝗷 ميوزك\n
⩹━★⊷⌯⌞ 𝗖𝗷 ⌝⌯⊶★━⩺

★قايمه مميزات سورس 𝗖𝗷 
