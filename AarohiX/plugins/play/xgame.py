...
async def E3DAM(client: Client, message: Message):
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞𝗦𝗼𝗨𝗿𝗖𝗲 𝗖𝗷⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب سي جي 3D\n\n⩹━★⊷━⌞𝗦𝗼𝗨𝗿𝗖𝗲 𝗖𝗷⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞𝗦𝗼𝗨𝗿𝗖𝗲 𝗖𝗷⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب سي جي\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞𝗦𝗼𝗨𝗿𝗖𝗲 𝗖𝗷⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب سي جي', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞𝗦𝗼𝗨𝗿𝗖𝗲 𝗖𝗷⌝⚡️', url =f"https://t.me/CG_G11")              
                 ],[
                InlineKeyboardButton(
